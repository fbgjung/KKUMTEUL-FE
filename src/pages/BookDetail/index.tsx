...
const books = [
    ...
    { id: 5, title: "책 5", author: "작가 2", price: 10000, publisher: "출판사 2", page: 220, summary: "이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.이 책은 과학의 원리를 설명합니다.", age_group: "9세 이상", book_image: "/assets/book.jpg", mbti: "INTP", topic: "과학", genre: "생활과 과학" },
